...
(return_statement
  ...
  local query = vim.treesitter.query.get("lua", "config_plugin_is_disabled")
...
local get_enabled_node = function(bufnr, tree)
  vim.treesitter.query.set(
    "lua",
    "config_plugin_has_enable_property",
    [[
(return_statement
  (expression_list
    (table_constructor
  ...
  local query = vim.treesitter.query.get("lua", "config_plugin_has_enable_property")
...
local get_return_node = function(bufnr, tree)
  vim.treesitter.query.set(
    "lua",
    "config_plugin_return_table_constructor",
    [[
(return_statement
  (expression_list
  ...
  local query = vim.treesitter.query.get("lua", "config_plugin_return_table_constructor")
